...
import { startStudySession, stopStudySession, getStudyHistory, deleteStudySession } from "../../../services/studentService";
                        ...
                        {history.map(session => (
                            <div key={session.id} className="history-row">
                                ...
                                <span className="history-duration">
                                    {session.status === 'COMPLETED' ? getDurationDisplay(session.durationMinutes) : '...'}
                                </span>
